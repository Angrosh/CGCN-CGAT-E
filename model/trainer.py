...
from model.cgcncgate import GCNClassifier
...
def unpack_batch(batch, cuda):
    ...
    if cuda:
        ...
        inputs.append(batch[9])
        inputs.append(batch[10])
        inputs.append(batch[11])
        inputs.append(batch[12])
        inputs.append(batch[13])
        labels = Variable(batch[13].cuda())
    else:
