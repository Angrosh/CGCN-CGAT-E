"""
Train a model on Semeval Dataset.
"""
...
parser.add_argument("--pmi_data_dir", type=str, default="data/pmi_data")
parser.add_argument(
    "--emb_dim", type=int, default=300, help="Word embedding dimension."
)
parser.add_argument(
    "--bert_emb_dim", type=int, default=1024, help="Word embedding dimension."
)
...
parser.add_argument(
    "--gcn_dropout", type=float, default=0.3, help="GCN layer dropout rate."
)
parser.add_argument(
    "--cnn_dropout", type=float, default=0.5, help="CNN layer dropout rate."
)
parser.add_argument(
    "--word_dropout",
    type=float,
...
parser.add_argument(
    "--heads", type=int, default=3, help="Num of heads in multi-head attention."
)
parser.add_argument(
    "--sublayer_first",
    type=int,
    default=2,
    help="Num of the first sublayers in dcgcn block.",
)
parser.add_argument(
    "--sublayer_second",
    type=int,
...
parser.add_argument(
    "--pooling",
    choices=["max", "avg", "sum", "self-att", "cnn"],
    default="max",
...
parser.add_argument(
    "--decay_epoch", type=int, default=6, help="Decay learning rate after this epoch."
)
parser.add_argument(
    "--optim",
...
for epoch in range(1, opt["num_epoch"]):
    ...
    if (
        ...
        and (train_loss - train_loss_history[-1]) > 0.001
